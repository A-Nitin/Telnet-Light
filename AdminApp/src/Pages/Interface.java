...
import myChat.chat.theServer;
import rtmserver.chat.Start;
import fileTransfer.ftServer;
...
public class Interface extends javax.swing.JFrame {
    ...
    public boolean cmd_start_stop = false;
    private int xMouse;
    private int yMouse;
    ...
    public void commandThread() throws IOException {
            cs = new commandServer(this);
            cs_thread = new Thread(cs);
            cs_thread.start();
    }
    ...
    public void changePanel(int panelNo){
        ...
        switch(panelNo){
            case 0:
                ...
                content += "<span>view <span style=\"color:rgb(85,65,118);"
                        + "font-size:20pt;font-weight:bold\">Your Profile</span> "
                        + "</span>";
            ...
            case 2:
                ...
                content += "<span>Here you can remotely execute certain <span style=\"color:rgb(85,65,118);"
                        + "font-size:20pt;font-weight:bold\">windows command</span> on cilent pc."
                        + "</span></html>";
                miancontent_label.setText(content);
                leftBtn.setVisible(true);
                leftBtn.setBounds(40,150,140,40);
                leftBtn_label.setText("Send Request");
                rightBtn.setVisible(false);
                break;
            case 3:
                heading_label.setText("Chat");
                content += "<span>You can <span style=\"color:rgb(85,65,118);"
                        + "font-size:20pt;font-weight:bold\">Chat</span> "
                        + " with clients only after starting the server. A popup will appear on clicking the chat now button.</span>";
                miancontent_label.setText(content);
                leftBtn.setVisible(true);
                leftBtn.setBounds(40,150,100,40);
                leftBtn_label.setText("Chat Now");
                rightBtn.setVisible(true);
                rightBtn.setBounds(180,150,130,40);
                rightBtn_label.setText("Start Server");
                break;
            case 4:
                heading_label.setText("File Transfer");
                content += "<span>You can send <span style=\"color:rgb(85,65,118);"
                        + "font-size:20pt;font-weight:bold\">Files</span> "
                        + "to multiple clients connected to the server.</span>";
                miancontent_label.setText(content);
                leftBtn.setVisible(true);
                leftBtn_label.setText("Send File");
                leftBtn.setBounds(40,150,100,40);
                rightBtn.setVisible(false);
                break;
            case 5:
            heading_label.setText("Remote Desktop Control");
            content += "<span>You can remotely access <span style=\"color:rgb(85,65,118);"
                    + "font-size:20pt;font-weight:bold\">Client's pc</span> "
                    + ".</span>";
            miancontent_label.setText(content);
            leftBtn.setVisible(true);
    ...
    private void initComponents() {
        ...
        miancontent_label.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        ...
        leftBtnLayout.setVerticalGroup(
            leftBtnLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(leftBtn_label, javax.swing.GroupLayout.DEFAULT_SIZE, 40, Short.MAX_VALUE)
        );
        ...
        rightBtnLayout.setHorizontalGroup(
            ...
            .addComponent(rightBtn_label, javax.swing.GroupLayout.DEFAULT_SIZE, 110, Short.MAX_VALUE)
        );
        rightBtnLayout.setVerticalGroup(
            rightBtnLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(rightBtn_label, javax.swing.GroupLayout.DEFAULT_SIZE, 40, Short.MAX_VALUE)
        );
        ...
        main_panelLayout.setHorizontalGroup(
            ...
            .addGroup(main_panelLayout.createSequentialGroup()
                .addGap(23, 23, 23)
                .addComponent(miancontent_label, javax.swing.GroupLayout.PREFERRED_SIZE, 392, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        main_panelLayout.setVerticalGroup(
            ...
            .addGroup(main_panelLayout.createSequentialGroup()
                .addGap(20, 20, 20)
                .addComponent(miancontent_label, javax.swing.GroupLayout.PREFERRED_SIZE, 97, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(47, 47, 47)
        ...
        jLabel17.setText("Remote Desktop Control");
        ...
        bg_panelLayout.setVerticalGroup(
            bg_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(menuicon_panel, javax.swing.GroupLayout.PREFERRED_SIZE, 443, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addComponent(menu_panel, javax.swing.GroupLayout.PREFERRED_SIZE, 443, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addGroup(bg_panelLayout.createSequentialGroup()
    ...
    private void leftBtn_labelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_leftBtn_labelMouseClicked
        ...
        switch(leftBtn_label.getText()){
            ...
            break;  
            case "start":
                Thread t1 = new Thread(new Start(this));
                t1.start();
                screenmonitor=true;
            break;
            case "Send File":
                ftServer fc = new ftServer();
    ...
    private void rightBtn_labelMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rightBtn_labelMouseMoved
        if(server_started)
            ...
            rightBtn.setBackground(new Color(54,33,89));
            rightBtn_label.setForeground(new Color(255,255,255));
        }
    ...
    private void rightBtn_labelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rightBtn_labelMouseClicked
        ...
        if(rightBtn_label.getText().equals("Start Server")){
            if(!server_started){
                server_started=true;
                new theServer(this).setVisible(true);
            }
        }
    ...
    private void rightBtn_labelMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rightBtn_labelMouseExited
        rightBtn.setBackground(new Color(255,255,255));
        rightBtn_label.setForeground(new Color(54,33,89));  
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Interface("nitin").setVisible(true);
            }
        });
    }
